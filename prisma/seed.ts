...
async function seedPrisma() {
  ...
  await prisma.$transaction([
    ...
    prisma.$executeRaw`INSERT INTO categories ("name") VALUES ('Projeto')`,
    prisma.$executeRaw`INSERT INTO categories ("name") VALUES ('Prática')`,
    prisma.$executeRaw`INSERT INTO categories ("name") VALUES ('Recuperação')`,
